...
const safetyTitles={en:'Safety and personal choice',nl:'Veiligheid en persoonlijke keuze',es:'Seguridad y elección personal'}
const SoundHealing=({language})=>{const currentLanguage=copy[language]?language:'en';const t=copy[currentLanguage];return <div className="pt-20">
  ...
  <section className="py-20 bg-white">
    <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-[1.05fr_.95fr] gap-10 lg:gap-14 items-center">
      ...
      <div className="overflow-hidden rounded-[2rem] shadow-[0_20px_55px_rgba(84,200,239,.16)]">
        <img src={resonanceInstruments} alt="Sound and resonance instruments used by Key of Self Love" loading="lazy" decoding="async" className="w-full h-[440px] md:h-[520px] object-cover object-center brightness-[1.12] saturate-[.82] contrast-[.92]" />
      </div>
    </div>
  </section>
  ...
  <section className="py-24 bg-cover bg-center" style={{backgroundImage:`linear-gradient(rgba(255,253,248,.76),rgba(255,253,248,.86)),url(${resonanceSafety})`}}>
    <div className="max-w-4xl mx-auto px-4 text-center">
      <h2 className="text-3xl md:text-4xl font-serif mb-5 text-amber-600">{safetyTitles[currentLanguage]}</h2>
